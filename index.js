...
var App = /** @class */ (function () {
    function App() {
        this.template = fs_1.default.readFileSync(path_1.default.resolve(__dirname, "KESU_Template.docx"), 'binary');
        this.timelog = fs_1.default.readFileSync(path_1.default.resolve(__dirname, "timelogs/" + timelogPath));
        this.month = '';
        this.result = {};
